...
#ifndef CPP3K_META_DETAIL_TUPLE_HPP
#define CPP3K_META_DETAIL_TUPLE_HPP
...
{
  static constexpr std::size_t size() { return Ops::size(); }
};

// Returns the Ith element of the reflected tuple.
template<std::size_t I, typename Ops>
auto get(reflected_tuple<Ops> const&) -> decltype(Ops::template get<I>()) {
...
template<typename Ops>
struct tuple_size<cpp3k::meta::reflected_tuple<Ops>>
  : std::integral_constant<std::size_t, Ops::size()>
{ };

template<std::size_t I, typename Ops>
struct tuple_element<I, cpp3k::meta::reflected_tuple<Ops>>
{
...
#endif /* CPP3K_META_DETAIL_TUPLE_HPP */
